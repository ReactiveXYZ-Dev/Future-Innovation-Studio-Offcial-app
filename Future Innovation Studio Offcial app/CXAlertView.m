...
-(CGFloat)heightThatFitsButton:(CXAlertButtonItem*)button
{
    ...
    CGFloat btht = [button.title boundingRectWithSize:desiredSize options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName: fnt} context:nil].size.height;
	return btht+22;
}
